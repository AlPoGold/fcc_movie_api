...
public class Movie {
    ...
    // Конструктор, который принимает ObjectId и сохраняет его как String
    public Movie(ObjectId id, String imdbId, String title, String releaseDate, String trailerLink, String poster,
                 List<String> backdrops, List<String> genres, List<Review> reviewsIds) {
        this.id = id.toHexString(); // Конвертация ObjectId в строку
        this.imdbId = imdbId;
        this.title = title;
